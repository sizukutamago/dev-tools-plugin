...
description: |
  ...
  Creates endpoint definitions, request/response schemas, and integration docs.
  Use when designing API endpoints, creating REST specifications, 
  defining external service integrations, or documenting API contracts.
context: fork
...
| ファイル | テンプレート | 説明 |
|---------|-------------|------|
| docs/05_api_design/api_design.md | {baseDir}/templates/api_design.md | API仕様 |
| docs/05_api_design/integration.md | {baseDir}/templates/integration.md | 外部連携仕様 |

## 依存関係

| 種別 | 対象 |
|------|------|
| 前提スキル | requirements-skill, database-skill |
| 後続スキル | design-skill |
