...
2. **Research** (if needed) - Use WebSearch or Context7 MCP
3. Ask user question for make decision
4. Apply decision to plan
5. Show the summary for user

### Phase 1.5: Research (Optional)

技術選択や不明点がある場合、質問前に調査を行う:

- **WebSearch**: 最新のベストプラクティス、ライブラリ比較、トレンド調査
- **Context7 MCP** (利用可能な場合): 公式ドキュメント、フレームワークパターン参照
