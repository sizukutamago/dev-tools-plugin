...
description: |
  Defines functional requirements (FR) and non-functional requirements (NFR) 
  for software projects. Use when creating requirement specifications, 
  documenting feature lists, defining performance/security constraints, 
  or establishing acceptance criteria.
context: fork
...
| ファイル | テンプレート | 説明 |
|---------|-------------|------|
| docs/02_requirements/requirements.md | {baseDir}/templates/requirements.md | 要件定義概要 |
| docs/02_requirements/functional_requirements.md | {baseDir}/templates/functional_requirements.md | 機能要件一覧 |
| docs/02_requirements/non_functional_requirements.md | {baseDir}/templates/non_functional_requirements.md | 非機能要件一覧 |
...
|------|------|
| 前提スキル | hearing-skill |
| 後続スキル | architecture-skill, database-skill |
...
| 2.0.0 | 出力ディレクトリを02_requirements/に変更 |
| 1.0.0 | 初版 |
