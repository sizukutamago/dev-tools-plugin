---
name: gemini-collab
description: Collaborate with Gemini CLI via tmux for web search, official docs/RFC/changelog lookup, compatibility checks, comparisons, or citations. Use when tasks require investigation with sourced information.
version: 2.0.0
---
