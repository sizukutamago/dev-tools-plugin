...
name: database-skill
description: |
  Defines data structures and entity models with TypeScript type definitions.
  Creates entity designs, validation rules, and type hierarchies.
  Use when designing data models, creating TypeScript interfaces, 
  defining entities, or establishing validation constraints.
context: fork
...
| ファイル | テンプレート | 説明 |
|---------|-------------|------|
| docs/04_data_structure/data_structure.md | {baseDir}/templates/data_structure.md | エンティティ定義 |
